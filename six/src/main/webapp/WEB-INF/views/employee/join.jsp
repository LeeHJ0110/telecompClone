...
<script defer src="${pageContext.request.contextPath}/js/employee/join.js"></script>
...
<form id="joinForm" enctype="multipart/form-data">
    ...
    <div class="address">
        ...
        <input type="text" name="address" id="address"  placeholder="주소" readonly style="flex: 1; background-color: #f5f5f5;">
    </div>


    <input type="text" name="address2" id="detailAddress" placeholder="상세 주소">
