...
<script defer src="${pageContext.request.contextPath}/js/admin/employeemanage/list.js"></script>
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/admin/employeemanage/list.css">
...
<div class="employee-container">
    ...
    <select id="searchType">
            ...
            <option value="agencyName">소속</option>
