...
<script defer src="${pageContext.request.contextPath}/js/board/notice/list.js"></script>
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/board/notice/list.css">
...
<input type="text" id="searchValue" placeholder="검색어를 입력해주세요." oninput="searchNotice();">
</div>
<main>
...
<button class="notice-btn" onclick = "location.href = `/board/notice/insert`" >글쓰기</button>
</div>
</c:if>
